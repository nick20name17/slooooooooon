        ...
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button
                    size="lg"
                    variant="outline"
                    className="max-md:w-full rounded-full border-markup bg-background px-3.5 text-lg font-bold drop-shadow-[3px_4px_0px_#BA5CE6] transition-all hover:bg-markup/15 hover:drop-shadow-none">
                    <PlusCircle className="mr-2 size-4 text-markup" />
                    Додати маркап
                </Button>
            </SheetTrigger>
