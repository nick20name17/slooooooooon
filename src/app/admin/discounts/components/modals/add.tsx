        ...
        <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
                <Button
                    size="lg"
                    variant="outline"
                    className="max-md:w-full rounded-full border-discount bg-background px-3.5 text-lg font-bold drop-shadow-[3px_4px_0px_#16c091] transition-all hover:bg-discount/15 hover:drop-shadow-none">
                    <PlusCircle className="mr-2 size-4 text-discount" />
                    Додати знижку
                </Button>
            </SheetTrigger>
                    ...
                    <form onSubmit={form.handleSubmit(onCostAdd)}>
                        <SheetHeader className="flex flex-row items-center justify-between gap-x-4 border-b py-4">
                            ...
                            <Button
                                type="submit"
                                variant="outline"
                                className="w-28 rounded-full border-discount bg-background px-3.5 text-lg font-bold drop-shadow-[3px_4px_0px_#16c091] transition-all hover:bg-discount/15 hover:drop-shadow-none">
                                {mutation.isLoading ? (
