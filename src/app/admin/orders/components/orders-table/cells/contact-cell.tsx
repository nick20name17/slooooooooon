...
export const ContactCell = ({ customer, waybill }: ContactCellProps) => {
    return (
        <Popover>
            <PopoverTrigger className='flex h-10 items-center gap-x-2 rounded-xl border px-2 py-1 transition-colors hover:border-green hover:outline hover:outline-[#3db57740]'>
                <svg
