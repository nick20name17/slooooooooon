                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onCustomerAdd)}>
                        <SheetHeader className='flex flex-row items-center justify-between gap-x-4 border-b py-4'>
                            <SheetTitle className='text-4xl'>Додати клієнта</SheetTitle>
                            <Button
                                type='submit'
                                variant='outline'
                                className='w-28 rounded-full border-sand bg-background px-3.5 text-lg font-bold drop-shadow-[3px_4px_0px_#ff9f0a] transition-all hover:bg-sand/15 hover:drop-shadow-none'>
                                {mutation.isLoading ? (
